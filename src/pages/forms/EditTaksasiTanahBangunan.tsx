        ...
        {bangunanList.map((bangunan, index) => (
          <div key={bangunan.id} className="rounded-xl border bg-card p-6 shadow-card">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div>
                <Label>Sumber Pembanding 1</Label>
                <Input value={bangunan.sumber_1} onChange={(e) => updateBangunan(index, 'sumber_1', e.target.value)} placeholder="Contoh: Kontraktor, Toko material, dll" />
              </div>
              <div>
                <Label>Harga Pembanding 2 (Rp/m²)</Label>
              ...
              <div>
                <Label>Sumber Pembanding 2</Label>
                <Input value={bangunan.sumber_2} onChange={(e) => updateBangunan(index, 'sumber_2', e.target.value)} placeholder="Contoh: Kontraktor, Toko material, dll" />
              </div>
              <div>
                <Label>Harga Pembanding 3 (Rp/m²)</Label>
              ...
              <div>
                <Label>Sumber Pembanding 3</Label>
                <Input value={bangunan.sumber_3} onChange={(e) => updateBangunan(index, 'sumber_3', e.target.value)} placeholder="Contoh: Kontraktor, Toko material, dll" />
              </div>
            </div>
            <div className="grid sm:grid-cols-2 gap-4 mt-4">
              <div>
